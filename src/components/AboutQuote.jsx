...
import aboutImg from "../assets/shopy4.webp"; 
      ...
      <div className="flex flex-col md:flex-row gap-10 items-start">
        ...
        <div className="w-full md:w-1/2 overflow-hidden rounded-lg shadow">
          <img
            src={aboutImg}
            alt="Our Story"
            className="w-full h-160 object-cover rounded-lg transform transition-transform duration-300 ease-in-out hover:scale-105 hover:brightness-90 cursor-pointer"
            draggable={false}
          />
        </div>
        <div className="w-full md:w-1/2">
         ...
         <div className="border-l-4 border-gray-200 ">
          <blockquote className="text-xl italic text-gray-400 mb-4 ml-4">
